...
// http://javascript-source.com
//***********************************************
jQuery("#wowslider-container1").wowSlider({effect:"kenburns",prev:"",next:"",duration:29*100,delay:82*100,width:960,height:360,autoPlay:true,playPause:true,stopOnHover:false,loop:false,bullets:0,caption:true,captionEffect:"move",controls:true,onBeforeStep:0,images:[{src:"./slider3.jpg",title:"slider3",descr:"asdasdsad",href:"gfdgerdff"},{src:"./slider4.jpg",title:"slider4",descr:"fdgdgdgd",href:"gdfgdgdfg"},{src:"./slider6.jpg",title:"slider6",descr:"fdgdgdfg",href:"dfgdgdfgdfgdfg"}]});