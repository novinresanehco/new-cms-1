...
(function ($) {
    ...
    jQuery.fn.jetmenu = function (options) {
		...
		var menuWrapper = $(".header-navi-inner");
		var menuText = menuWrapper.data("menu-name");

		$(menu).prepend("<li class='showhide'><span class='title'>"+menuText+"</span><span class='icon'><em></em><em></em><em></em><em></em></span></li>");

		if (settings.indicator == true) {
            $(menu).find("a").each(function () {
                if ($(this).siblings(".dropdown, .megamenu").length > 0) {
                    $(this).append("<span class='indicator'><i class='awesome-angle-down'></i></span>");
                }
            });
        }
