...
Set ShowChangeLangButton, KeyBoardError, ChangeDir variables values with your own opinon!
	...
	KeyBoardError // the method when useres keyboard is farsi --> 0: Disable FarsiType / 1: Show Error
	ChangeDir // change the input or textarea direction when language is change --> 0: No method / 1: Change direction / 2: set Rtl/Ltr button
...
var FarsiType = 
{
	...
	ChangeDir : 2 // 0: No method / 1: Do Rtl-Ltr / 2: Rtl-Ltr button
}
