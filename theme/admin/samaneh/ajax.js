var sload = '<center><img src=../theme/admin/samaneh/images/load1.gif></center>';
var ncsload= '<img src=../theme/admin/samaneh/images/load1.gif>';
var loadingt = "<center>لطفا صبر کنید...<br><br><img border='0' src='../theme/admin/samaneh/images/loading.gif'><center>";
var note='<br><br><p align="center" dir="rtl">مشکلی در بر قراری ارتباط رخ داد. از وجود ارتباط با سرور مطمئن شوید و مجددا تلاش کنید<br><br><img border="0" src="../theme/admin/samaneh/images/error.gif"><br>[ <a onclick="showfrm();" href="#reload">بازیابی فرم</a> ]</p>';
...
writeid(resultid,'<center><br><br><img src=../theme/admin/websun/images/loading.gif\><br><a onclick=stopajax("frame","currentframe","ajaxcontent","result2"); href="#">[لغو عملیات]</a></center>');
hideid(hide);
}
...
connect('pages/listsociallinks.php',"r",'ajax_tabs_1_content',loadingt,'');
break;
case 'edit_link':
connect('pages/listlinks.php',"r",'ajax_tabs_1_content',loadingt,'');
break;
